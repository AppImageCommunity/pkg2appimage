...
Welcome to AppImages, a collection of AppImages for demonstration purposes. Please do NOT request AppImages for applications here if one does not exist yet; in this case, please ask the application authors instead. We do support upstream application authors who would like to provide AppImages; please go to https://github.com/AppImage/AppImageKit/wiki.
